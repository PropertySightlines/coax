...
mod true_positives {
    ...
    fn test_aws_access_key_ids() {
        ...
        assert!(
            filter.is_likely_secret("AKIAIOSFODNN7EXAMPLE", "aws_access_key_id = AKIAIOSFODNN7EXAMPLE"),
            "AWS Access Key ID should be detected"
        );
        assert!(
            filter.is_likely_secret("AKIAI44QH8DHBEXAMPLE", "aws_access_key_id: AKIAI44QH8DHBEXAMPLE"),
            "AWS Access Key ID should be detected"
        );
        assert!(
    ...
    fn test_slack_tokens() {
        ...
        // Slack Bot Tokens
        assert!(
            filter.is_likely_secret("xoxb-123456789012-1234567890123-AbCdEfGhIjKlMnOpQrStUvWx", "SLACK_BOT_TOKEN=xoxb-123456789012-1234567890123-AbCdEfGhIjKlMnOpQrStUvWx"),
...
mod metrics {
    ...
    fn test_true_positive_rate() {
        ...
        let true_positives = vec![
            ...
            ("xoxb-123456789012-1234567890123-AbCdEfGhIjKlMnOpQrStUvWx", "slack_token = xoxb-123456789012-1234567890123-AbCdEfGhIjKlMnOpQrStUvWx"),
